...
> Copy this file to `ADR-00N-short-title.md` and fill it in. Never edit an accepted ADR —
...
| Enforced by | Where |
|---|---|
| FF-### / manual review by [role] | [`fitness-functions.md`](../../04-technical-spec/fitness-functions.md) |
...
| Compliance | A decision with no enforcement mechanism decays from the day it is written. |
