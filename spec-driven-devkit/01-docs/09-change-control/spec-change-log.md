...
| 2026-08-04 | `decisions.md`, `open-questions.md`, `traceability.md` | **+DD-023, supersedes DD-020**; **Q-024 closed**; REQ-NF-002 moves from *no implementation path* to Ready | Wrapper blueprints carry the two non-Markdown artifacts. DD-020 was a correct reading of the Markdown-only rule and the wrong outcome — it left a Must requirement unsatisfiable and every generated workspace inviting a `.env` with no ignore rule | **v1.9** |
| 2026-08-04 | `traceability.md`, `task-index.md` | TASK-011, 012, 013, 014 marked Done; nine REQ rows linked | **The intake now runs end to end**: install, interview, write, gate, resume, validate, entry point, hand-off. Thirteen instruction modules, 242 tests | **v1.11** |
| 2026-08-04 | `traceability.md`, `task-index.md` | REQ-R-005 linked; TASK-010 marked Done | Rounds 7–8 landed, and with them the clause the governance story rests on | **v1.10** |
| 2026-08-04 | `traceability.md`, `task-index.md` | REQ-F-028, REQ-NF-003 linked; TASK-007 marked Done | Resume landed, and with it **ETEST-014 ×8** — the gate half TASK-020 had to leave unreachable. The reliability driver's measure is now met at 8/8 rather than asserted | **v1.8** |
