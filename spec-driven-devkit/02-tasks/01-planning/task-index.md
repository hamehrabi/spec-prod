...
| TASK-016 | Golden fixtures and the eval harness | `ai-evals.md` | **P1** | TASK-014 | **Done** — *EV-001 produced by a real eight-round run and swapped in as the committed baseline (2026-08-08); GOLD-001 rewritten against it, none of its pins softened; 35 cases stay enumerated and deliberately not built (`ai-evals.md` §1)* | agent | **EV-001**, ETEST-011, ETEST-012 |
| TASK-017 | Round progress indicator | REQ-F-032 | P2 | TASK-011 | **Done** | agent | ATEST-036 |
| TASK-018 | Cross-platform verification on all three OSes | REQ-NF-008 | P2 | TASK-016 | **Partly done** — *Step 0 AND the full deterministic suite run on all three OSes in CI (`suite` job, 2026-08-08); FTEST-009 written; what remains is exactly ETEST-012 — the model-driven interview ×3 — which needs real hosts and spend, and stays **not run** rather than claimed* | agent | ETEST-012 (×3), **FTEST-009** |
