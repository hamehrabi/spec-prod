...
| TASK-004 | **The boundary layer** — path check, collisions, protected files | REQ-F-014, REQ-F-024, REQ-F-026, REQ-F-035, REQ-F-036, SEC-Z-001 | **P0** | TASK-001 | **Done** — *rule verified; the run-level denials wait for TASK-006* | agent | UTEST-019, STEST-002…008, STEST-013, FTEST-003, FTEST-007, FTEST-008 |
...
| TASK-007 | Resume — derive stage by inspection | REQ-F-028, REQ-NF-003 | **P1** | TASK-006 | Not started | agent | ATEST-032, UTEST-021, **ETEST-009 (×8)**, FTEST-001, FTEST-011, FTEST-016 |
...
| TASK-012 | Validation — twelve checks, retry once, not-run reporting | REQ-F-029, REQ-F-037 | **P1** | TASK-010 | Not started | agent | ATEST-024, ATEST-033, UTEST-018, UTEST-022, TEST-015, FTEST-005, FTEST-006 |
| TASK-013 | Entry point written last, under 100 lines, version stamped | REQ-F-020, REQ-NF-009, ADR-005 | **P1** | TASK-012 | Not started | agent | ATEST-021, TEST-009, ETEST-001, FTEST-017 |
...
| **TASK-020** | **The stage acceptance gate** — present, then accept / revise / stop | REQ-F-038, REQ-F-039, REQ-F-041, ADR-006 | **P0** | TASK-006 | Not started | agent | ATEST-041…043, ATEST-045, UTEST-026…029, **ETEST-013**, **ETEST-014 (×8)**, FTEST-019, FTEST-022, STEST-016 |
