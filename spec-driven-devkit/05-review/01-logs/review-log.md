...
| 5 | **Two sessions in one repository would both write to `spec/`.** No lock, no state file permitted | Medium | **SC-008 open; TASK-019 blocked.** Found by the seven-questions worksheet, not by design review |
