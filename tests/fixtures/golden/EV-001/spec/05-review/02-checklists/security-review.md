...
- [ ] Account scoping is applied to every query (single-user; BR-003).
...
- [ ] Uploaded dish photos are private and never served from a public URL.
...
|---|---|---|
| A request reaches another account's data. | **Critical** | Review authorization rule and security logs immediately. |
